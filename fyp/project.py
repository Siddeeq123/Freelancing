...
def predictOutput(Name):
    ...
    rectCon = utills.rectContour(contours)
    # FILTER FOR RECTANGLE CONTOURS
    biggestPoints= utills.getCornerPoints(rectCon[0])

    # GET CORNER POINTS OF THE BIGGEST RECTANGLE
    gradePoints = utills.getCornerPoints(rectCon[1])
    # GET CORNER POINTS OF THE SECOND BIGGEST RECTANGLE
    if biggestPoints.size != 0 and gradePoints.size != 0:

            # BIGGEST RECTANGLE WARPING
        biggestPoints=utills.reorder(biggestPoints)
        # REORDER FOR WARPING
